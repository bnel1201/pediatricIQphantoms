OUTPUT_DIR=${1-/gpfs_projects/brandon.nelson/DLIR_Ped_Generalizability/geometric_phantom_studies/main}
...
# MTF
cmd="bash MTF/_1_run_MTF_analysis.sh ${OUTPUT_DIR}/geometric"
...
# LCD
cmd="bash LCD/_1_run_LCD_analysis.sh ${OUTPUT_DIR}/geometric ${RESULTS_DIR}/LCD"
if [ $(hostname) == openhpc ]; then
    bash ../ssh_node.sh "$cmd; exit"
else
    $cmd
...
bash anthro_mse/_1_run_anthro_mse_analysis.sh $OUTPUT_DIR/anthropomorphic/simulations $RESULTS_DIR/anthropomorphic
